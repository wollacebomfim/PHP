...
<center><h3> Login</br>PADI </h3></center>
</div>
...
<input name="senha" type="password"  minlength="11" maxlength="11" size="11" placeholder="INSIRA SEU CPF" required onkeypress="return onlynumber();">
</div><br>
...
<a href="#"class="btn-large red"> Administrador</button></a>
</center>
<br>
